...
Systems zu decken.
Im Rahmen einer Laufzeitanalyse 
\end{abstract}
...
Laufzeit von 1266 Tagen für den Betrieb des digitalen Raumbelegungsplans mit einem 1000 mAh Akku ermittelt werden. Durch folgende Formel kann die wöchentlich 
benötigte Energie für den Betrieb des digitalen Raumbelegungsplans berechnet werden, wobei \(E_{\text{wöchentlich}}\) die wöchentliche Energie und \(E_{\text{total}}\) die
gesamte Energie des Akkus ist:
...
Mit diesem Energiebedarf von etwa 20,458 mWh pro Woche und einer Energiegewinnung von etwa 40,117 mWh pro Woche durch das Photovoltaik-System, kann festgestellt 
werden, dass die Energiegewinnung durch das Photovoltaik-System ausreichend ist.
