...
Der Firebeetle 2 ESP32 Mikrocontroller soll so programmiert werden, dass er alle 60 Sekunden aufwacht und drei mal aufeinanderfolgend mit einer Sekunde Pause die Messdaten 
des INA226 ausliest. Anschließend soll der Median der drei Messungen berechnet werden, um Ausreißer zu minimieren. Die gesammelten Daten sollen über eine WLAN-Verbindung 
...
\subsection{Konzeption der Vereinigung von Photovoltaik- und Strommesssystem}
