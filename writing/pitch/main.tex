...
Raumbelegungsplans-Prototyps in geringen mWh Bereich pro Woche. Eine effiziente Energieversorgung könnte die Laufzeit des Systems 
erheblich verlängern oder sogar eine vollständige Autarkie ermöglichen. Ziel der Arbeit ist es ein System zu konzipieren, das 
...
Systems zu decken.
Im Rahmen einer Laufzeitanalyse des im ersten Forschungssemester entwickelten Raumbelegungsplanprototyps konnte eine angestrebter 
Energiegewinn von mindestens 20,458 mWh pro Woche ermittelt werden um einen autarken betrieb gewährleisten zu können. Basierend 
darauf konnte eine Recherche von passenden Photovoltaiktzellen und Ladereglern durchgeführt werden, die diesen Energiebedarf decken.
Eine Kombination von vier LL200-3.6-75 Photofilm Photovoltaikzellen im Verbund mit einem BQ25570 Laderegler stellte sich als 
vielversprechender Ansatz heraus. Um den Stromverbrauch zu messen wurde zusätzlich ein Strommesssystem mit dem INA226 
Strommonitoring-Chip und einem Firebeetle 2 ESP32 realisiert, welches eine Messauflösung von 0,25 µA ermöglicht. 
Das Photovoltaiksystem wurde vom 16.01.2026 bis zum 16.02.2026 im Raum C 625 am Wilhemininhofcampus der HTW Berlin betrieben und 
konnte in dieser Zeit eine durchschnittlichen wöchentlichen Energiegewinn von 40,117 mWh erzeugen. Dieses Ergebniss übersteigt 
die Zielsetzung von 20,458 mWh pro Woche deutlich, wodurch der Raumbelegungsplan autark betrieben werden könnte. 
\end{abstract}
